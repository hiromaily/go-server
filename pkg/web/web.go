...
import (
	...
	c "github.com/hiromaily/go-server/pkg/controller"
	mw "github.com/hiromaily/go-server/pkg/middleware"
	"github.com/hiromaily/go-server/pkg/session"
...
func (w *Web) SetStaticFiles() {
	//static files
	w.Mux.Handle("/img/", http.StripPrefix("/img/", http.FileServer(http.Dir("./web/statics/img"))))
	w.Mux.Handle("/css/", http.StripPrefix("/css/", http.FileServer(http.Dir("./web/statics/css"))))
	w.Mux.Handle("/js/", http.StripPrefix("/js/", http.FileServer(http.Dir("./web/statics/js"))))
...
func faviconHandler(w http.ResponseWriter, r *http.Request) {
	...
	http.ServeFile(w, r, "./web/statics/favicon.ico")
}
